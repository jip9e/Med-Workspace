# Med-Workspace V3 Pro Max Plan

## Task 1: Pro-Grade UI/UX Foundations
- [x] Setup medical-grade typography: Install 'Figtree' and 'Noto Sans'.
- [x] Configure Tailwind theme with the new fonts.
...
- [x] Update 'App.tsx' to use the Bento layout:
  ...
  - Vertical tile for NotesManager.
