    ...
    <div className="h-full flex flex-col bg-clinical-black/40 backdrop-blur-xl border border-clinical-border text-white p-6 rounded-2xl">
      ...
      <div className="flex gap-4 mb-8">
        <button 
          ...
          className="flex-1 min-h-[48px] flex items-center justify-center gap-3 bg-medical-blue-600 hover:bg-medical-blue-500 disabled:bg-gray-800 disabled:text-gray-600 rounded-xl transition-all active:scale-[0.98] shadow-lg shadow-medical-blue-900/20 font-black uppercase tracking-[0.2em] text-[10px]"
        >
      ...
      <div className="border-t border-white/5 pt-6 flex-1 flex flex-col overflow-hidden">
        <div className="flex items-center justify-between mb-4">
          ...
          <button 
            ...
            className="min-w-[44px] min-h-[44px] flex items-center justify-center text-medical-blue-400 hover:text-medical-blue-300 disabled:text-gray-800 transition-all bg-medical-blue-500/5 hover:bg-medical-blue-500/10 rounded-full border border-medical-blue-500/10 active:scale-95"
        ...
        <div className="flex-1 overflow-y-auto space-y-4 scrollbar-hide pb-4">
          {notes.map(note => (
            <div key={note.id} className="group p-4 bg-white/5 border border-white/5 hover:border-medical-blue-500/30 hover:bg-white/[0.07] rounded-xl transition-all cursor-default relative">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <CheckCircle2 className="w-3.5 h-3.5 text-medical-blue-500/40 group-hover:text-medical-blue-500/80 transition-colors" />
                </div>
              </div>
